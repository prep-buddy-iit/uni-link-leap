...
export const JEE_FAQS: FAQ[] = [
  ...
  { q: "Can I cancel my PrepBuddy plan or get a refund?", a: "No. All PrepBuddy purchases are final - plans, the ₹99 trial and the ₹999 session are non-refundable, and plans cannot be cancelled part-way through. If your mentor isn't the right fit we will re-match you with a different mentor at no extra cost, and plans of 3 months and above can be paused once for up to 15 days. Try the ₹99 trial first if you are unsure." },

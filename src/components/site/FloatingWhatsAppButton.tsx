...
export function FloatingWhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2">
      <span
        className={`
          pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-full
          bg-white px-3 py-1.5 text-xs font-medium text-ink shadow-soft
      ...
      <a
        ...
        className={`
          ...
          ${pressed ? "scale-95" : "scale-100 hover:scale-[1.08]"}
        `}
        style={{
          backgroundColor: "#25D366",
          boxShadow: pressed
            ? "0 8px 20px -6px rgba(37, 211, 102, 0.35)"
            : "0 10px 28px -8px rgba(37, 211, 102, 0.45)",
        }}
      ...
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          className="h-7 w-7 text-white transition-transform duration-300 group-hover:scale-105"
          aria-hidden="true"
        >
